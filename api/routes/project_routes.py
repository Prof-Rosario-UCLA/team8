...
def get_all_projects_for_user(user_id: UUID):
    try:
        ...
        projects = ctrl.get_all_projects_for_user(user_id, include_bullets=include_bullets, include_skills=include_skills)
...
def get_project(project_id: UUID):
    try:
        include_bullets = request.args.get('include_bullets', 'false').lower() == 'true'
        include_skills = request.args.get('include_skills', 'false').lower() == 'true'
        project = ctrl.get_project(project_id, include_bullets=include_bullets, include_skills=include_skills)
