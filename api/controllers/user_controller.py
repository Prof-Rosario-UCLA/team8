...
from .website_controller import serialize_website, create_website as wc_create, update_website as wc_update, delete_website as wc_delete, get_websites_for_user as wc_get_for_user
...
def update_user(user_id, data):
    ...
    try:
        ...
        if 'websites' in data:
            ...
            for site_data in incoming_websites_data:
                ...
                if site_id and str(site_id) in existing_websites:
                    ...
                    wc_create(user_id, new_site_data) # website_controller.create_website
        ...
        return serialize_user(user, include_details=True) # Assuming include_details fetches websites
    except SQLAlchemyError as e:
        db.session.rollback()
